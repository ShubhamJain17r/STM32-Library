/**
 * @file uart_traits.hpp
 * @brief Hardware traits and IRQ mappings for USART1 through USART6
 */
...
{
    static USART_TypeDef* peripheral() noexcept { return USART1; }
    ...
    static void enableClock() noexcept { rcc::enablePeripheralClock(peripheral()); }
};

template<>
struct Traits<Instance::usart2>
{
    static USART_TypeDef* peripheral() noexcept { return USART2; }
...
{
    static USART_TypeDef* peripheral() noexcept { return USART3; }
...
{
    static USART_TypeDef* peripheral() noexcept { return UART4; }
...
{
    static USART_TypeDef* peripheral() noexcept { return UART5; }
...
{
    static USART_TypeDef* peripheral() noexcept { return USART6; }
